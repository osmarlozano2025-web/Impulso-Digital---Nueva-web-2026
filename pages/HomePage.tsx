...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-background-subtle py-20 lg:py-32">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Button
                  onClick={openBooking}
                  variant="secondary"
                  className="px-6 sm:px-8 py-4 sm:py-5 text-sm sm:text-lg min-h-[56px] sm:min-h-[64px] shadow-lg shadow-secondary/20"
                >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="group p-6 sm:p-8 rounded-3xl bg-slate-50 border border-transparent hover:border-primary/20 hover:bg-white hover:shadow-2xl transition-all duration-300">
              ...
              <Button onClick={openBooking} variant="outline" fullWidth>Saber más</Button>
            </div>
            ...
            <div className="group p-6 sm:p-8 rounded-3xl bg-slate-50 border border-transparent hover:border-secondary/20 hover:bg-white hover:shadow-2xl transition-all duration-300">
              ...
              <Button onClick={openBooking} variant="outline" fullWidth>Ver Demo</Button>
            </div>
            ...
            <div className="group p-6 sm:p-8 rounded-3xl bg-slate-50 border border-transparent hover:border-primary/20 hover:bg-white hover:shadow-2xl transition-all duration-300">
              ...
              <Button onClick={openBooking} variant="outline" fullWidth>Proyectos</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-b from-white to-slate-50">
        <AIInsights variant="home" className="mx-auto max-w-7xl px-4" title="Innovación 2026: Tu Ventaja Injusta" />
      </section>

      {/* CTA Section */}
      <section className="py-24 px-4 bg-slate-900 text-white overflow-hidden relative">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-primary/10 skew-x-[-20deg]"></div>
        <div className="mx-auto max-w-4xl text-center relative z-10 space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              onClick={openBooking}
              variant="secondary"
              className="px-10 py-5 text-lg sm:text-xl shadow-xl min-h-[64px]"
            >
